    ...
    const funfootmanl5=()=>{
        ...
        return(< div className="cover">
            <div className="category">
                <li className="l"><Link to="/about"><img src={grocery}></img><p className="blue">Grocery</p></Link></li>
                <li className="l" ><Link to="/about"><img src={mobile}></img><p className="blue">Mobile</p></Link></li>
                <li className="l" onMouseEnter={funenter2} onMouseLeave={funleave2} ><Link to="/about"><img src={faction}></img><p className="blue">Fashion {onenter2==true?<FontAwesomeIcon icon={faChevronUp} className="down"/>:<FontAwesomeIcon icon={faChevronDown} className="down"/>} </p></Link>
                {
                    onenter2==true?
